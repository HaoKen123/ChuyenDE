# COPY CODE LÊN KAGGLE

Bạn hãy copy từng khối lệnh dưới đây và dán vào từng Cell tương ứng trên Kaggle.

## 🟩 CELL 1: CÀI ĐẶT THƯ VIỆN BẮT BUỘC
`python
# ==============================================================
...
## 🟩 CELL 2: CẤU HÌNH MÔI TRƯỜNG & IMPORTS
`python
# ==============================================================
...
## 🟩 CELL 3: KHAI BÁO ĐƯỜNG DẪN (PATHS)
`python
# ─── PATHS ────────────────────────────────────────────────────
...
## 🟩 CELL 4: THÔNG SỐ HUẤN LUYỆN (HYPERPARAMETERS)
`python
# ─── HYPERPARAMETERS ──────────────────────────────────────────
...
## 🟩 CELL 10: HÀM XUẤT BÁO CÁO (REPORTS)
`python
# ══════════════════════════════════════════════════════════════
# 5. REPORT GENERATION
# ══════════════════════════════════════════════════════════════
